-- ============================================================
-- PCG Map -- locations table setup (locked down)
-- Run this in the Supabase SQL editor. This creates the
-- locations table with the same data the app has always shown,
-- but with NO anon/authenticated read policy: only the
-- service-role key (used by Netlify functions) can read or
-- write it, matching the profiles table's security model.
-- ============================================================
